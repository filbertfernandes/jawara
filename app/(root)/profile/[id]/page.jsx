...
export default function Page({ params }) {
  return (
    <div className="fullscreen-orange-100 flex-wrap gap-6 overflow-scroll font-questrial font-bold text-white">
      ...
      <div className="flex h-auto w-full items-center justify-center rounded-xl bg-gradient-to-r from-orange-500 to-orange-700 px-2 py-4 text-center">
        <h2 className="h2-bold">Filbert Fernandes Lienardy</h2>
      </div>
      <div className="flex max-h-80 min-h-80 w-full flex-wrap justify-center overflow-scroll rounded-xl bg-gradient-to-r from-orange-500 to-orange-700 px-2 py-4">
      ...
      <div className="flex h-auto w-full flex-col items-center justify-center rounded-xl bg-gradient-to-r from-orange-500 to-orange-700 px-2 py-4 text-center">
        <h1 className="text-8xl">39</h1>
        <p>Total Correct Translations</p>
      </div>
      <div className="mb-8 flex h-auto w-full flex-col items-center justify-center rounded-xl bg-gradient-to-r from-orange-500 to-orange-700 px-6 py-4 text-center">
        ...
        <div className="mb-4 flex w-full flex-wrap items-center border-b-2 border-white pb-4">
          ...
          <IoBody className="ml-1 text-2xl" />
          <div className="mt-1 flex w-full justify-between">
            <h6 className="text-base lg:text-lg">Ngoko</h6>
            <h6 className="text-base lg:text-lg">0</h6>
          </div>
          <div className="mt-1 flex w-full justify-between">
            <h6 className="text-base lg:text-lg">Krama Madya</h6>
            <h6 className="text-base lg:text-lg">0</h6>
          </div>
          <div className="mt-1 flex w-full justify-between">
            <h6 className="text-base lg:text-lg">Krama Alus</h6>
            <h6 className="text-base lg:text-lg">0</h6>
          </div>
        </div>
        <div className="mb-4 flex w-full flex-wrap items-center border-b-2 border-white pb-4">
          <h3 className="h5-bold">Colors</h3>
          <IoColorPalette className="ml-1 text-2xl" />
          <div className="mt-1 flex w-full justify-between">
            <h6 className="text-base lg:text-lg">Ngoko</h6>
            <h6 className="text-base lg:text-lg">0</h6>
          </div>
        ...
        <div className="mb-4 flex w-full flex-wrap items-center border-b-2 border-white pb-4">
          ...
          <GoNumber className="ml-1 text-2xl" />
          <div className="mt-1 flex w-full justify-between">
            <h6 className="text-base lg:text-lg">Ngoko</h6>
            <h6 className="text-base lg:text-lg">0</h6>
          </div>
        ...
        <div className="mb-4 flex w-full flex-wrap items-center border-b-2 border-white pb-4">
          ...
          <MdOutlinePets className="ml-1 text-2xl" />
          <div className="mt-1 flex w-full justify-between">
            <h6 className="text-base lg:text-lg">Ngoko</h6>
            <h6 className="text-base lg:text-lg">0</h6>
          </div>
