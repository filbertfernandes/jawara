...
export async function getFriendRequest(userId) {
  try {
    ...
    const friendRequests = await FriendRequest.find(
      ...
      .populate("sender", "name username profileAvatarIndex") // Populate sender's name, username, profileAvatarIndex
    ...
    const formattedRequests = friendRequests.map((req) => ({
      ...
      sender: {
        ...
        profileAvatarIndex: req.sender.profileAvatarIndex, // Keep sender's profileAvatarIndex
      },
    }));
