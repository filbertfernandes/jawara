...
const GameOverInterface = ({ score, startGame }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-6 w-full h-[90%]" onKeyDown={handleKeyDown}>

            <div className="text-center">
                <h1 className='text-4xl text-sky-400 drop-shadow-lg font-bold lg:text-6xl'>CONGRATULATIONS!</h1>
                <h5 className='text-xl text-sky-400 drop-shadow-lg font-bold lg:text-3xl'>
                    Your score is {score}
                </h5>
            </div>
