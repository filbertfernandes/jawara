        ...
        <div className={ `flex flex-col items-center gap-6 w-full h-full mt-8 sm:gap-4 sm:-mt-8 ${isVisible ? 'animate-bounceIn' : 'opacity-0'}` }>
            ...
            <div className="flex flex-wrap gap-4 justify-evenly w-full h-full px-4 text-white overflow-y-auto sm:px-0 sm:gap-1">
                {words.map((word, index) => (
                    <div key={ index } className="flex justify-between items-center w-full h-36 bg-stone-800/50 rounded-[1rem] mb-2 pl-4 sm:w-[45%] lg:w-[30%]">
                        <img 
                        ...
                        <div className="flex flex-col w-full h-full px-4 py-4">
                            ...
                            <div className="flex justify-between text-base">
                                <div>
                                    { word.ngoko } <span className="text-[0.5rem] text-white/50">(Ngoko)</span>
                                </div>
                                <div>
                                    <PiSpeakerHighBold />
                                </div>
                            ...
                            <div className="flex justify-between text-base">
                                <div>
                                    { word.madya } <span className="text-[0.5rem] text-white/50">(Krama Madya)</span>
                                </div>
                                <div>
                                    <PiSpeakerHighBold />
                                </div>
                            ...
                            <div className="flex justify-between text-base">
                                <div>
                                    { word.alus } <span className="text-[0.5rem] text-white/50">(Krama Alus)</span>
                                </div>
                                <div>
                                    <PiSpeakerHighBold />
                                </div>
