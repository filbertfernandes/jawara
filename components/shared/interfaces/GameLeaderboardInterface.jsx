  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between text-white w-[90%] h-10 bg-stone-800/50 px-4 rounded-lg sm:text-lg sm:w-[70%] md:text-xl lg:text-2xl lg:w-[50%]">
        <div
          className="flex items-center text-center border-sky-400 border-b-2"
          ...
          <li className="flex justify-between border-white/10 border-b-2 pt-1 pb-3 px-1 mb-4">
            <div className="flex">
              <div className="avatar">
                ...
                <span className="absolute -top-1 -left-1 bg-yellow-500 text-white text-xs font-bold rounded-full w-[1.125rem] h-[1.125rem] flex items-center justify-center">
                  1
                </span>
              </div>

              <div className="flex items-center ml-4">Filbert Fernandes</div>
            </div>
          ...
          <li className="flex justify-between border-white/10 border-b-2 pt-1 pb-3 px-1 mb-4">
            <div className="flex">
              <div className="avatar">
                ...
                <span className="absolute -top-1 -left-1 bg-slate-500 text-white text-xs font-bold rounded-full w-[1.125rem] h-[1.125rem] flex items-center justify-center">
                  2
                </span>
              </div>
          ...
          <li className="flex justify-between border-white/10 border-b-2 pt-1 pb-3 px-1 mb-4">
            <div className="flex">
              <div className="avatar">
                ...
                <span className="absolute -top-1 -left-1 bg-orange-700 text-white text-xs font-bold rounded-full w-[1.125rem] h-[1.125rem] flex items-center justify-center">
                  3
                </span>
              </div>
          ...
          <li className="flex justify-between border-white/10 border-b-2 pt-1 pb-3 px-1 mb-4">
            <div className="flex">
              <div className="avatar">
                ...
                <span className="absolute -top-1 -left-1 bg-black text-white text-xs font-bold rounded-full w-[1.125rem] h-[1.125rem] flex items-center justify-center">
                  4
                </span>
              </div>
