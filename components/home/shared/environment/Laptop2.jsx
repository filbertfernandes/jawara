...
export function Laptop(props) {
  ...
  return (
    <group {...props} dispose={null} scale={3.2}>
      <Html
        transform
        distanceFactor={1.17}
        position={[-2.842, 0.528, 1.6264]}
        rotation-x={-0.256}
        // rotation-x={0}
        occlude
      >
        <div className="flex h-20 w-28 justify-center overflow-scroll rounded-sm border-none bg-white p-1 font-questrial text-[0.5rem] text-gray-900">
