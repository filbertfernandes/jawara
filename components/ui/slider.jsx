...
const Slider = React.forwardRef(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-1.5 w-full grow overflow-hidden rounded-full bg-orange-500/30 dark:bg-slate-50/20">
      <SliderPrimitive.Range className="absolute h-full bg-orange-500 dark:bg-slate-50" />
